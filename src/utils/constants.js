...
export const cardsArray = [
  ...
  },
  {
    ...
    text: 'Торт, созданный благодаря идеальному сочетанию карамели и арахиса',
    link: latteImage,
  ...
  {
    title: 'Сникерс',
    text: 'Насыщенный, сытный и богатый на сочетание вкусов десерт, созданный по мотивам одноименного шоколадного батончика',
    link: snickersImage,
    alt: 'Торт сникерс',
    cost: '1000 р.',
    description: [
  ...
  {
    title: 'Наполеон',
    text: 'Многослойный торт из слоёного теста с заварным кремом',
    link: napoleonImage,
    alt: 'Торт наполеон',
    cost: '1000 р.',
    description: [
  ...
  },
  {
    ...
    text: 'Нежный и насыщенный вкус сыра дорблю соединился с натуральным соком маракуйи, создав невероятный десерт',
